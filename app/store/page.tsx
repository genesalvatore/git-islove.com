  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <NetworkNav 
        ...
        siteColor="bg-gradient-to-r from-pink-400 via-rose-400 to-red-400 text-transparent bg-clip-text"
      />
      ...
      <footer className="border-t border-gray-800 py-8 mt-16">
        <div className="max-w-7xl mx-auto px-4 text-center text-gray-400">
          <p className="text-sm">Git is Love • Love Persists • Love is Eternal</p>
